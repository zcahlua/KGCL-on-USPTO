...
from kgcl_retro.data.dataset_config import DatasetSpec, get_dataset_spec, normalize_dataset_name, normalize_split_name  # Explanation: exposes dataset wrappers for training and evaluation files.
...
__all__ = [  # Explanation: defines the public data package API.
    ...
    "normalize_split_name",  # Explanation: includes the evaluation reaction dataset in the public API.
